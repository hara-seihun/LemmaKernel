...
| heat_dirichlet | cell_blocks | 5,060 | 3 s | 0.0268 s | 112× | 1,539× |
...
| heat_dirichlet | cell_terms | the mollified summands of one canopy cell, n from 2 to D N_+ = 4242000, summed | 4,241,999 | 580 s~ | 7.64 s | 0.403 s | 76× | 1,438× |
| heat_dirichlet | cell_blocks | the part of that cell above N_- in blocks of 700 (a thousandth of n, which costs the bound well under a percent) | 5,060 | 3 s | 0.0268 s | 0.00195 s | 112× | 1,539× |
