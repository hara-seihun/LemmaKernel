...
| heat_dirichlet | cell_terms | the mollified summands of one canopy cell, n from 2 to D N_+ = 4242000, summed | 4,241,999 | 618 s~ | 8.86 s | 0.467 s | 70× | 1,323× |
| heat_dirichlet | cell_blocks | the part of that cell above N_- in blocks of 700 (a thousandth of n, which costs the bound well under a percent) | 5,060 | 4.95 s | 0.0369 s | 0.00266 s | 134× | 1,859× |
