...
| [circuit_fires](modules/circuit_fires/manifest.toml) | concise-circuit conditions and fire existence over prime fields, with bounded potential construction and verification | `line_quotient` (automatic exact dense or sparse elimination), `reduced_polynomial` (independent cached finite-difference row spaces) |
